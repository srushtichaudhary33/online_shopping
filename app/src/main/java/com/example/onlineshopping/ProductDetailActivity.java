...
public class ProductDetailActivity extends AppCompatActivity implements PaymentResultWithDataListener {
    ...
    private void startPayment() {
        ...
        checkout.setKeyID("rzp_test_TyS1ODHCcmILq6");
...
//            options.put("order_id", "order_"+sp.getString(ConstantSp.PRODUCTID,""));`
    ...
    public void onPaymentError(int i, String s, PaymentData paymentData) {
        alertMethod("Payment Failed","OOPS!!! Your Payment Faild");
    }
